...
public class OpenAPIDocumentationConfig {
  ...
  public Docket customImplementation(
      ServletContext servletContext, @Value("${openapi.daytime.base-path:/api}") String basePath) {
    return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.ionos.demo.daytime.openapi.api"))
        .build()
